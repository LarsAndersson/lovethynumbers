			...
			<div class="container-fluid">
				...
				<ul class="nav pull-right">
					...
					<li class="dropdown user">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
						<img alt="" src="<? echo $global_user->user_image; ?>" />
						<span class="username"><? echo $global_user->user_first . " " . $global_user->user_last; ?></span>
						<i class="icon-angle-down"></i>
						</a>
						<ul class="dropdown-menu">
							<li><a href="profile?id=<?php echo $global_user->user_id; ?>"><i class="icon-user"></i><? echo $_['global_my_profile']; ?></a></li>
							...
							<li><a href="logout"><i class="icon-key"></i><? echo $_['global_log_out']; ?></a></li>
						</ul>
					</li>
