<!-- BEGIN SIDEBAR -->
		<div class="page-sidebar nav-collapse collapse">
			...
			<ul class="page-sidebar-menu">
				...
				<li class="start <?php echo (strpos($_SERVER['REQUEST_URI'],'index'))? 'active' : ''; ?>">
					<a href="index">
					<i class="icon-home"></i> 
					<span class="title"><?php echo $_['global_dashboard']; ?></span>
					</a>
				</li>
				
				<!-- Profile menu -->
				<li class="tooltips <?php echo (strpos($_SERVER['REQUEST_URI'],'profile'))? 'active' : ''; ?>" data-placement="right" data-original-title="<?php echo $_['global_my_profile_help']; ?>">
					<a href="profile?id=<?php echo $global_user->user_id; ?>">
					<i class="icon-user"></i> 
				...
				<li class="tooltips <?php echo (strpos($_SERVER['REQUEST_URI'],'screens'))? 'active' : ''; ?>" data-placement="right" data-original-title="<?php echo $_['global_content_help']; ?>">
					...
					<span class="title"><?php echo $_['global_screens']; ?></span>
					</a>
				</li>
				...
				<li>
					<a href="javascript:;">
					<i class="icon-cogs"></i> 
					<span class="title"><?php echo $_['global_admin']; ?></span>
					...
					<ul class="sub-menu">
						...
						<li class="<?php echo (strpos($_SERVER['REQUEST_URI'],'users'))? 'active' : ''; ?>">
							<a href="users">
								<i class="icon-user"></i>
								<?php echo $_['global_users']; ?>
							</a>
						</li>
						<li >
							<!--
